...
<?php 
        ...
        <div class="nk-layout-bottom-center">
            <nav class="nk-nav">
                <ul>
                    <li>
                        <a href="mailto:info@umbrella.com">view More</a>
                    </li>
                </ul>
            </nav>
        </div>
...
<!-- <footer class="footer">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
			<p>Copywrite @2020 <a href=""> SAS Creative</a></p>
			</div>
		</div>
	</div>
</footer> -->
  ...
  <script src="<?php echo get_template_directory_uri(); ?>/vender/umbrella/bower_components/gsap/src/minified/TweenMax.min.js"></script>
    ...
    <!-- History.js -->
    <script src="<?php echo get_template_directory_uri(); ?>/vender/umbrella/bower_components/history.js/scripts/bundled/html5/jquery.history.js"></script>
