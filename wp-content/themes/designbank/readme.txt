...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/design_bank.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/design_bank)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what design_bank is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for design_bank.

At the moment, design_bank is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# design_bank WordPress Theme Framework

Website: [https://design_bank.com](https://design_bank.com)

Child Theme Project: [https://github.com/holger1411/design_bank-child](https://github.com/holger1411/design_bank-child)

## License
design_bank WordPress Theme, Copyright 2013-2017 Holger Koenemann
...
- Jetpack ready.
- WooCommerce support.
- [Child Theme](https://github.com/holger1411/design_bank-child) ready.
- Translation ready.
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or design_bank variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "design_bank/design_bank"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the design_bank folder from GitHub or from design_bank.com
